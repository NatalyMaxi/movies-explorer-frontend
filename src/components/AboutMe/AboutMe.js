         ...
         <div className='about-me__container'>
            <div className='about-me__info'>
               ...
               <p className='about-me__description'>
                  Я живу в Тюмени. По образованию юрист. В последнее время стал появляться интерес к программированию. В итоге прошла курсы Яндекс. Практикума "Веб-разработчик". Обучение очень понравилось, теперь еще больше желание углубиться в эту профессию и стать востребованным специалистом.
               </p>
